# -*- coding: utf-8 -*-
"""
Created on Tue Dec 21 21:17:19 2021
...
plt.bar(label , value, color="violet")
...
plt.bar(index , values, width=0.4 , color = "teal")
...
plt.bar (labels ,values , width= 0.5 , color= "olive")
